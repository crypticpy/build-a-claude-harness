...
function countImporters(imports, editedRel) {
  ...
  for (const [consumer, targets] of Object.entries(imports)) {
    ...
    // TODO (the one blank): `consumer` imports the edited file if ANY of its
    // import `targets` has the same basename as `stem` (extension-tolerant).
    // When it matches, push `consumer` onto `consumers`.
    // Hint:
