...
// (This table is written for you — read it, don't change it.)
const DENY_RULES = [
  {
...
export function evaluate(req) {
  ...
  // TODO (your one blank): DEFAULT-ALLOW.
  // No named-harm rule matched. Return an ALLOW decision — the friction-reduction
  // direction is "allow unless a concrete harm was named". Match the shape the
  // deny branch returns above: { decision, rule, reason }, with rule = null.
  // Do NOT invert this to deny-by-default; that defeats the entire tool.
